...
bool dbz_native_step(Cpu *c, DbzExecution *x) {
  ...
  } else if(c->pc == 0x9535 || c->pc == 0x9538 || c->pc == 0x953a || c->pc == 0x953c || c->pc == 0x953e || c->pc == 0x9540 || c->pc == 0x9543 || c->pc == 0x9544 || c->pc == 0x9546 || c->pc == 0x954c || c->pc == 0x954e || c->pc == 0x9550 || c->pc == 0x9554 || c->pc == 0x9556 || c->pc == 0x9559 || c->pc == 0x955d || c->pc == 0x9560) {
