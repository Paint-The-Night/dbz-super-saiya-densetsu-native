...
bool dbz_native_step(Cpu *c, DbzExecution *x) {
  ...
  if(bank == 3) {
    if(c->pc == 0x9752 || c->pc == 0x9753 || c->pc == 0x9755 || c->pc == 0x9756 || c->pc == 0x9758 || c->pc == 0x975a || c->pc == 0x975c || c->pc == 0x975e || c->pc == 0x9760 || c->pc == 0x9761 || c->pc == 0x9763 || c->pc == 0x9764 || c->pc == 0x9765) {
