...
| **Total** | **Sixty complete routines plus a reset prefix** | **3056** | **1491** |
...
worklist contains 13,237 instruction variants. Of those, 1491 instruction sites
are covered by reviewed C replacements: **11.26% of the discovered worklist**.
...
The current inventory is 3056 ROM bytes / 1491 instruction sites.
