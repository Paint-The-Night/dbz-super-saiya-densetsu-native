...
| 05:96F3–9700 | VMAIN=#$80; JSL $00C5ED/$00C707; RTS (callee of $C029) | 14 | 5 |
...
| **Total** | **One hundred fifty-two complete routines plus a reset prefix** | **10933** | **4942** |
...
worklist contains 13,237 instruction variants. Of those, 4942 instruction sites
are covered by reviewed C replacements: **37.33% of the discovered worklist**.
...
The current inventory is 10933 ROM bytes / 4942 instruction sites.
