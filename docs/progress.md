...
The bank-3 actor helper XBA at `$03:9755` is now native and differentially verified, adding 1 site and 1 byte. The following actor-helper setup instructions at `$03:9756–$03:9760` (LDA, four DP stores, and XBA) are also native and differentially verified, adding 6 sites and 11 bytes.
