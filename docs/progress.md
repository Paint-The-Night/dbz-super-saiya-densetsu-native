...
| **Total** | **Fifty-eight complete routines plus a reset prefix** | **2694** | **1301** |
...
worklist contains 13,237 instruction variants. Of those, 1301 instruction sites
are covered by reviewed C replacements: **9.83% of the discovered worklist**.
...
The current inventory is 2694 ROM bytes / 1301 instruction sites.
